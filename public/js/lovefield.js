...
(function () {
  'use strict'; var $jscomp = { scope: {} }; var goog = goog || {}
  goog.global = this
  goog.isDef = function (val) {
    return void 0 !== val
  }
  goog.exportPath_ = function (name, opt_object, opt_objectToExportTo) {
    var parts = name.split('.'); var cur = opt_objectToExportTo || goog.global
  ...
  goog.globalize = function (obj, opt_global) {
    var global = opt_global || goog.global; var x
    for (x in obj) {
      global[x] = obj[x]
    }
  }
  goog.addDependency = function (relPath, provides, requires, opt_loadFlags) {
    if (goog.DEPENDENCIES_ENABLED) {
      var provide; var require; var path = relPath.replace(/\\/g, '/'); var deps = goog.dependencies_
      opt_loadFlags && typeof opt_loadFlags !== 'boolean' || (opt_loadFlags = opt_loadFlags ? { module: 'goog' } : {})
  ...
  goog.DEPENDENCIES_ENABLED && (goog.dependencies_ = { loadFlags: {}, nameToPath: {}, requires: {}, visited: {}, written: {}, deferred: {} }, goog.inHtmlDocument_ = function () {
    ...
    if (goog.isDef(goog.global.CLOSURE_BASE_PATH)) {
      ...
      if (goog.inHtmlDocument_()) {
        for (var doc = goog.global.document, scripts = doc.getElementsByTagName('SCRIPT'), i = scripts.length - 1; i >= 0; --i) {
          var script = scripts[i]; var src = script.src; var qmark = src.lastIndexOf('?'); var l = qmark == -1 ? src.length : qmark
    ...
    var path = goog.getPathFromDeps_(name); var loadFlags = path && goog.dependencies_.loadFlags[path] || {}; var languageLevel = loadFlags.lang || 'es3'
    ...
    var doc = goog.global.document; var scriptEl = doc.createElement('script')
    ...
    script.readyState == 'complete' && goog.lastNonModuleScriptIndex_ == scriptIndex && goog.loadQueuedModules_()
    return !0
    ...
    var scripts = []; var seenScript = {}; var deps = goog.dependencies_
    ...
    for (i = 0; i < scripts.length; i++) {
      if (path$jscomp$0 = scripts[i]) {
        var loadFlags = deps.loadFlags[path$jscomp$0] || {}; var languageLevel = loadFlags.lang || 'es3'; var needsTranspile = goog.needsTranspile_(languageLevel)
        loadFlags.module == 'goog' || needsTranspile ? goog.importProcessedScript_(goog.basePath + path$jscomp$0, loadFlags.module == 'goog', needsTranspile) : goog.importScript_(goog.basePath + path$jscomp$0)
      } else {
  ...
  goog.workaroundSafari10EvalBug = function (moduleDef) {
    var srcUrlRE = /\/\/# sourceURL.*\n/g; var srcMapUrlRE = /\/\/# sourceMappingURL.*\n/g; var srcUrlLine = goog.getLastREMatch_(moduleDef, srcUrlRE); var srcMapUrlLine = goog.getLastREMatch_(moduleDef, srcMapUrlRE)
  ...
  goog.loadModule = function (moduleDef) {
    ...
    try {
      ...
      goog.moduleLoaderState_.declareLegacyNamespace ? goog.constructNamespace_(moduleName, exports) : goog.SEAL_MODULE_EXPORTS && Object.seal && typeof exports === 'object' && exports != null && Object.seal(exports)
  ...
  goog.transpile_ = function (code$jscomp$0, path$jscomp$0) {
    ...
    if (!transpile) {
      var transpilerPath = goog.basePath + goog.TRANSPILER; var transpilerCode = goog.loadFileSync_(transpilerPath)
      if (transpilerCode) {
    ...
    if (!transpile) {
      var suffix = ' requires transpilation but no transpiler was found.'; var suffix = suffix + ' Please add "//javascript/closure:transpiler" as a data dependency to ensure it is included.'; var transpile = jscomp.transpile = function (code, path) {
    ...
    if (goog.global.execScript) {
      ...
      if (goog.global.eval) {
        if (goog.evalWorksForGlobals_ == null) {
          if (goog.global.eval('var _evalTest_ = 1;'), typeof goog.global._evalTest_ !== 'undefined') {
            try {
        ...
        if (goog.evalWorksForGlobals_) {
          ...
          var doc = goog.global.document; var scriptElt = doc.createElement('SCRIPT')
  ...
  goog.defineClass.createSealingConstructor_ = function (ctr, superClass) {
    ...
    var superclassSealable = !goog.defineClass.isUnsealable_(superClass); var wrappedCtr = function () {
  ...
  goog.createRequiresTranspilation_ = function () {
    ...
    var requiresTranspilation = { es3: !1 }; var transpilationRequiredForAllLaterModes = !1
  ...
  goog.string.caseInsensitiveCompare = function (str1, str2) {
    var test1 = String(str1).toLowerCase(); var test2 = String(str2).toLowerCase()
  ...
  goog.string.numberAwareCompare_ = function (str1, str2, tokenizerRegExp) {
    ...
    for (var tokens1 = str1.toLowerCase().match(tokenizerRegExp), tokens2 = str2.toLowerCase().match(tokenizerRegExp), count = Math.min(tokens1.length, tokens2.length), i = 0; i < count; i++) {
      var a = tokens1[i]; var b = tokens2[i]
      if (a != b) {
  ...
  goog.string.htmlEscape = function (str, opt_isLikelyToContainHtmlChars) {
    if (opt_isLikelyToContainHtmlChars) {
      ...
      str.indexOf('&') != -1 && (str = str.replace(goog.string.AMP_RE_, '&amp;'))
      str.indexOf('<') != -1 && (str = str.replace(goog.string.LT_RE_, '&lt;'))
      str.indexOf('>') != -1 && (str = str.replace(goog.string.GT_RE_, '&gt;'))
      str.indexOf('"') != -1 && (str = str.replace(goog.string.QUOT_RE_, '&quot;'))
      str.indexOf("'") != -1 && (str = str.replace(goog.string.SINGLE_QUOTE_RE_, '&#39;'))
      str.indexOf('\x00') != -1 && (str = str.replace(goog.string.NULL_RE_, '&#0;'))
      goog.string.DETECT_DOUBLE_ESCAPING && str.indexOf('e') != -1 && (str = str.replace(goog.string.E_RE_, '&#101;'))
    }
    return str
  }
  ...
  goog.string.truncateMiddle = function (str, chars, opt_protectEscapedCharacters, opt_trailingChars) {
    ...
    if (opt_trailingChars && str.length > chars) {
      ...
      var endPoint = str.length - opt_trailingChars; var startPoint = chars - opt_trailingChars
      str = str.substring(0, startPoint) + '...' + str.substring(endPoint)
    } else {
      if (str.length > chars) {
        var half = Math.floor(chars / 2); var endPos = str.length - half; var half = half + chars % 2
  ...
  goog.string.quote = function (s) {
    ...
    for (var sb = ['"'], i = 0; i < s.length; i++) {
      var ch = s.charAt(i); var cc = ch.charCodeAt(0)
  ...
  goog.string.compareVersions = function (version1, version2) {
    for (var order = 0, v1Subs = goog.string.trim(String(version1)).split('.'), v2Subs = goog.string.trim(String(version2)).split('.'), subCount = Math.max(v1Subs.length, v2Subs.length), subIdx = 0; order == 0 && subIdx < subCount; subIdx++) {
      ...
      do {
        var v1Comp = /(\d*)(\D*)(.*)/.exec(v1Sub) || ['', '', '', '']; var v2Comp = /(\d*)(\D*)(.*)/.exec(v2Sub) || ['', '', '', '']
        if (v1Comp[0].length == 0 && v2Comp[0].length == 0) {
          break
        }
        var v1CompNum = v1Comp[1].length == 0 ? 0 : parseInt(v1Comp[1], 10); var v2CompNum = v2Comp[1].length == 0 ? 0 : parseInt(v2Comp[1], 10); var order = goog.string.compareElements_(v1CompNum, v2CompNum) || goog.string.compareElements_(v1Comp[2].length == 0, v2Comp[2].length == 0) || goog.string.compareElements_(v1Comp[2], v2Comp[2]); var v1Sub = v1Comp[3]; var v2Sub = v2Comp[3]
      } while (order == 0)
    }
    return order
  }
  ...
  goog.string.toTitleCase = function (str, opt_delimiters) {
    var delimiters = goog.isString(opt_delimiters) ? goog.string.regExpEscape(opt_delimiters) : '\\s'; var delimiters = delimiters ? '|[' + delimiters + ']+' : ''; var regexp = new RegExp('(^' + delimiters + ')([a-z])', 'g')
  ...
  goog.asserts.doAssertFailure_ = function (defaultMessage, defaultArgs, givenMessage, givenArgs) {
    ...
    if (givenMessage) {
      var message = message + (': ' + givenMessage); var args = givenArgs
    } else {
  ...
  goog.async.FreeList.prototype.get = function () {
    var item
    this.occupants_ > 0 ? (this.occupants_--, item = this.head_, this.head_ = item.next, item.next = null) : item = this.create_()
    return item
  }
  ...
  goog.functions.compose = function (fn, var_args) {
    var functions = arguments; var length = functions.length
    return function () {
      var result
  ...
  goog.functions.throttle = function (f, interval, opt_scope) {
    var timeout = 0; var shouldFire = !1; var args = []; var handleTimeout = function () {
      timeout = 0
  ...
  goog.functions.rateLimit = function (f, interval, opt_scope) {
    var timeout = 0; var handleTimeout = function () {
      timeout = 0
    }
    return function (var_args) {
  ...
  goog.array.indexOf = goog.NATIVE_ARRAY_PROTOTYPES && (goog.array.ASSUME_NATIVE_FUNCTIONS || Array.prototype.indexOf) ? function (arr, obj, opt_fromIndex) {
    ...
    if (goog.isString(arr)) {
      return goog.isString(obj) && obj.length == 1 ? arr.indexOf(obj, fromIndex) : -1
    }
  ...
  goog.array.lastIndexOf = goog.NATIVE_ARRAY_PROTOTYPES && (goog.array.ASSUME_NATIVE_FUNCTIONS || Array.prototype.lastIndexOf) ? function (arr, obj, opt_fromIndex) {
    ...
    if (goog.isString(arr)) {
      return goog.isString(obj) && obj.length == 1 ? arr.lastIndexOf(obj, fromIndex) : -1
    }
  ...
  goog.array.remove = function (arr, obj) {
    var i = goog.array.indexOf(arr, obj); var rv;
    (rv = i >= 0) && goog.array.removeAt(arr, i)
    return rv
  }
  goog.array.removeLast = function (arr, obj) {
    var i = goog.array.lastIndexOf(arr, obj)
    return i >= 0 ? (goog.array.removeAt(arr, i), !0) : !1
  }
  ...
  goog.array.extend = function (arr1, var_args) {
    for (var i = 1; i < arguments.length; i++) {
      ...
      if (goog.isArrayLike(arr2)) {
        var len1 = arr1.length || 0; var len2 = arr2.length || 0
  ...
  goog.array.removeDuplicates = function (arr, opt_rv, opt_hashFn) {
    for (var returnArray = opt_rv || arr, defaultHashFn = function (item) {
      ...
      var current = arr[cursorRead++]; var key = hashFn(current)
  ...
  goog.array.binarySearch_ = function (arr, compareFn, isEvaluator, opt_target, opt_selfObj) {
    for (var left = 0, right = arr.length, found; left < right;) {
      var middle = left + right >> 1; var compareResult
  ...
  goog.array.binaryInsert = function (array, value, opt_compareFn) {
    ...
    return index < 0 ? (goog.array.insertAt(array, value, -(index + 1)), !0) : !1
  }
  ...
  goog.array.bucket = function (array, sorter, opt_obj) {
    for (var buckets = {}, i = 0; i < array.length; i++) {
      var value = array[i]; var key = sorter.call(opt_obj, value, i, array)
      if (goog.isDef(key)) {
  ...
  goog.array.range = function (startOrEnd, opt_end, opt_step) {
    var array = []; var start = 0; var end = startOrEnd; var step = opt_step || 1
  ...
  goog.array.shuffle = function (arr, opt_randFn) {
    for (var randFn = opt_randFn || Math.random, i = arr.length - 1; i > 0; i--) {
      var j = Math.floor(randFn() * (i + 1)); var tmp = arr[i]
      arr[i] = arr[j]
      arr[j] = tmp
    }
  }
  ...
  goog.object.is = function (v, v2) {
    return v === v2 ? v !== 0 || 1 / v === 1 / v2 : v !== v && v2 !== v2
  }
  ...
  goog.object.get = function (obj, key, opt_val) {
    return obj !== null && key in obj ? obj[key] : opt_val
  }
  ...
  goog.labs.userAgent.browser.getVersion = function () {
    ...
    var versionTuples = goog.labs.userAgent.util.extractVersionTuples(userAgentString); var versionMap = {}
    goog.array.forEach(versionTuples, function (tuple) {
      var key = tuple[0]; var value = tuple[1]
  ...
  goog.labs.userAgent.browser.getIEVersion_ = function (userAgent) {
    ...
    var version = ''; var msie = /MSIE +([\d\.]+)/.exec(userAgent)
    if (msie && msie[1]) {
  ...
  goog.labs.userAgent.engine.getVersion = function () {
    var userAgentString = goog.labs.userAgent.util.getUserAgent()
    if (userAgentString) {
      var tuples = goog.labs.userAgent.util.extractVersionTuples(userAgentString); var engineTuple = goog.labs.userAgent.engine.getEngineTuple_(tuples)
      if (engineTuple) {
        return engineTuple[0] == 'Gecko' ? goog.labs.userAgent.engine.getVersionForKey_(tuples, 'Firefox') : engineTuple[1]
      }
      var browserTuple = tuples[0]; var info
  ...
  goog.async.nextTick.getSetImmediateEmulator_ = function () {
    ...
    typeof Channel === 'undefined' && typeof window !== 'undefined' && window.postMessage && window.addEventListener && !goog.labs.userAgent.engine.isPresto() && (Channel = function () {
      var iframe = document.createElement('IFRAME')
      iframe.style.display = 'none'
      iframe.src = ''
      document.documentElement.appendChild(iframe)
      var win = iframe.contentWindow; var doc = win.document
      doc.open()
      doc.write('')
      doc.close()
      var message = 'callImmediate' + Math.random(); var origin = win.location.protocol == 'file:' ? '*' : win.location.protocol + '//' + win.location.host; var onmessage = goog.bind(function (e) {
    ...
    if (typeof Channel !== 'undefined' && !goog.labs.userAgent.browser.isIE()) {
      var channel = new Channel(); var head = {}; var tail = head
    ...
    return typeof document !== 'undefined' && 'onreadystatechange' in document.createElement('SCRIPT') ? function (cb) {
  ...
  goog.Promise.all = function (promises) {
    return new goog.Promise(function (resolve, reject) {
      var toFulfill = promises.length; var values = []
      if (toFulfill) {
  ...
  goog.Promise.allSettled = function (promises) {
    return new goog.Promise(function (resolve) {
      var toSettle = promises.length; var results = []
      if (toSettle) {
  ...
  goog.Promise.firstFulfilled = function (promises) {
    return new goog.Promise(function (resolve, reject) {
      var toReject = promises.length; var reasons = []
      if (toReject) {
  ...
  goog.Promise.withResolver = function () {
    var resolve; var reject; var promise = new goog.Promise(function (rs, rj) {
      resolve = rs
      reject = rj
    })
  ...
  goog.Promise.tryThen_ = function (thenable, then, onFulfilled, onRejected, context) {
    var called = !1; var resolve = function (value) {
  ...
  goog.Promise.prototype.addStackTrace_ = function (err) {
    if (goog.Promise.LONG_STACK_TRACES && goog.isString(err.stack)) {
      var trace = err.stack.split('\n', 4)[3]; var message = err.message; var message = message + Array(11 - message.length).join(' ')
  ...
  goog.Promise.addUnhandledRejection_ = function (promise, reason) {
    ...
    }, goog.Promise.UNHANDLED_REJECTION_DELAY) : goog.Promise.UNHANDLED_REJECTION_DELAY == 0 && (promise.hadUnhandledRejection_ = !0, goog.async.run(function () {
  ...
  goog.math.sampleVariance = function (var_args) {
    ...
    var mean = goog.math.average.apply(null, arguments); var variance = goog.math.sum.apply(null, goog.array.map(arguments, function (val) {
  ...
  goog.iter.toIterator = function (iterable) {
    ...
    if (goog.isArrayLike(iterable)) {
      var i = 0; var newIter = new goog.iter.Iterator()
  ...
  goog.iter.filter = function (iterable, f, opt_obj) {
    var iterator = goog.iter.toIterator(iterable); var newIter = new goog.iter.Iterator()
    newIter.next = function () {
      for (;;) {
  ...
  goog.iter.range = function (startOrStop, opt_stop, opt_step) {
    var start = 0; var stop = startOrStop; var step = opt_step || 1
  ...
  goog.iter.chainFromIterable = function (iterable) {
    var iterator = goog.iter.toIterator(iterable); var iter = new goog.iter.Iterator(); var current = null
    iter.next = function () {
      for (;;) {
        if (current == null) {
  ...
  goog.iter.dropWhile = function (iterable, f, opt_obj) {
    var iterator = goog.iter.toIterator(iterable); var newIter = new goog.iter.Iterator(); var dropping = !0
    newIter.next = function () {
      for (;;) {
        var val = iterator.next()
  ...
  goog.iter.takeWhile = function (iterable, f, opt_obj) {
    var iterator = goog.iter.toIterator(iterable); var iter = new goog.iter.Iterator()
    iter.next = function () {
      var val = iterator.next()
      if (f.call(opt_obj, val, void 0, iterator)) {
        return val
  ...
  goog.iter.equals = function (iterable1, iterable2, opt_equalsFn) {
    var fillValue = {}; var pairs = goog.iter.zipLongest(fillValue, iterable1, iterable2); var equalsFn = opt_equalsFn || goog.array.defaultCompareEquality
  ...
  goog.iter.product = function (var_args) {
    ...
    var iter = new goog.iter.Iterator(); var arrays = arguments; var indicies = goog.array.repeat(0, arrays.length)
    iter.next = function () {
      if (indicies) {
  ...
  goog.iter.cycle = function (iterable) {
    var baseIterator = goog.iter.toIterator(iterable); var cache = []; var cacheIndex = 0; var iter = new goog.iter.Iterator(); var useCache = !1
    iter.next = function () {
  ...
  goog.iter.count = function (opt_start, opt_step) {
    var counter = opt_start || 0; var step = goog.isDef(opt_step) ? opt_step : 1; var iter = new goog.iter.Iterator()
    iter.next = function () {
  ...
  goog.iter.accumulate = function (iterable) {
    var iterator = goog.iter.toIterator(iterable); var total = 0; var iter = new goog.iter.Iterator()
    iter.next = function () {
  ...
  goog.iter.zip = function (var_args) {
    var args = arguments; var iter = new goog.iter.Iterator()
    if (args.length > 0) {
  ...
  goog.iter.zipLongest = function (fillValue, var_args) {
    var args = goog.array.slice(arguments, 1); var iter = new goog.iter.Iterator()
    if (args.length > 0) {
      var iterators = goog.array.map(args, goog.iter.toIterator)
      iter.next = function () {
        var iteratorsHaveValues = !1; var arr = goog.array.map(iterators, function (it) {
          var returnValue
          try {
  ...
  goog.iter.tee = function (iterable, opt_num) {
    var iterator = goog.iter.toIterator(iterable); var num = goog.isNumber(opt_num) ? opt_num : 2; var buffers = goog.array.map(goog.array.range(num), function () {
      return []
  ...
  goog.iter.limit = function (iterable, limitSize) {
    ...
    var iterator = goog.iter.toIterator(iterable); var iter = new goog.iter.Iterator(); var remaining = limitSize
    iter.next = function () {
      if (remaining-- > 0) {
  ...
  goog.iter.permutations = function (iterable, opt_length) {
    var elements = goog.iter.toArray(iterable); var length = goog.isNumber(opt_length) ? opt_length : elements.length; var sets = goog.array.repeat(elements, length); var product = goog.iter.product.apply(void 0, sets)
  ...
  goog.iter.combinations = function (iterable, length) {
    ...
    var elements = goog.iter.toArray(iterable); var indexes = goog.iter.range(elements.length); var indexIterator = goog.iter.permutations(indexes, length); var sortedIndexIterator = goog.iter.filter(indexIterator, function (arr) {
  ...
  goog.iter.combinationsWithReplacement = function (iterable, length) {
    ...
    var elements = goog.iter.toArray(iterable); var indexes = goog.array.range(elements.length); var sets = goog.array.repeat(indexes, length); var indexIterator = goog.iter.product.apply(void 0, sets); var sortedIndexIterator = goog.iter.filter(indexIterator, function (arr) {
      return goog.array.isSorted(arr)
    }); var iter = new goog.iter.Iterator()
    iter.next = function () {
      return goog.array.map(sortedIndexIterator.next(), getIndexFromElements)
  ...
  goog.structs.Map.prototype.forEach = function (f, opt_obj) {
    for (var keys = this.getKeys(), i = 0; i < keys.length; i++) {
      var key = keys[i]; var value = this.get(key)
  ...
  goog.structs.Map.prototype.transpose = function () {
    for (var transposed = new goog.structs.Map(), i = 0; i < this.keys_.length; i++) {
      var key = this.keys_[i]; var value = this.map_[key]
  ...
  goog.structs.Map.prototype.__iterator__ = function (opt_keys) {
    this.cleanupKeysArray_()
    var i = 0; var version = this.version_; var selfObj = this; var newIter = new goog.iter.Iterator()
    newIter.next = function () {
  ...
  goog.labs.userAgent.platform.getVersion = function () {
    var userAgentString = goog.labs.userAgent.util.getUserAgent(); var version = ''; var re
    if (goog.labs.userAgent.platform.isWindows()) {
      re = /Windows (?:NT|Phone) ([0-9.]+)/
      var match = re.exec(userAgentString); var version = match ? match[1] : '0.0'
    } else {
  ...
  goog.userAgent.determineVersion_ = function () {
    var version = ''; var arr = goog.userAgent.getVersionRegexResult_()
  ...
  var doc$jscomp$inline_3 = goog.global.document; var mode$jscomp$inline_4 = goog.userAgent.getDocumentMode_()
  JSCompiler_inline_result$jscomp$1 = doc$jscomp$inline_3 && goog.userAgent.IE ? mode$jscomp$inline_4 || (doc$jscomp$inline_3.compatMode == 'CSS1Compat' ? parseInt(goog.userAgent.VERSION, 10) : 5) : void 0
...
*/
  ...
  lf.structs.map.keys = function (map) {
    ...
    var i = 0; var array = Array(map.size)
...
*/
  ...
  lf.Row.binToHex = function (buffer) {
    ...
    for (var uint8Array = new Uint8Array(buffer), s = '', i = 0; i < uint8Array.length; ++i) {
      var chr = uint8Array[i].toString(16); var s = s + (chr.length < 2 ? '0' + chr : chr)
    }
    return s
  }
  ...
  lf.backstore.BaseTx.prototype.mergeTableChanges_ = function () {
    ...
    diff.forEach(function (tableDiff, tableName) {
      var tableSchema = this.journal_.getScope().get(tableName); var table = this.getTable(tableSchema.getName(), tableSchema.deserializeRow.bind(tableSchema), lf.backstore.TableType.DATA); var toDeleteRowIds = lf.structs.map.values(tableDiff.deleted_).map(function (row) {
        return row.id()
      })
      toDeleteRowIds.length > 0 && table.remove(toDeleteRowIds).thenCatch(this.handleError_, this)
    ...
    if (goog.isNull(this.stats_)) {
      if (this.success_) {
        if (this.txType == lf.TransactionType.READ_ONLY) {
          ...
          var diff = this.journal_.tableDiffs_; var insertedRows = 0; var deletedRows = 0; var updatedRows = 0; var tablesChanged = 0
  ...
  goog.structs.getCount = function (col) {
    return col.getCount && typeof col.getCount === 'function' ? col.getCount() : goog.isArrayLike(col) || goog.isString(col) ? col.length : goog.object.getCount(col)
  }
  ...
  goog.structs.contains = function (col, val) {
    return col.contains && typeof col.contains === 'function' ? col.contains(val) : col.containsValue && typeof col.containsValue === 'function' ? col.containsValue(val) : goog.isArrayLike(col) || goog.isString(col) ? goog.array.contains(col, val) : goog.object.containsValue(col, val)
  }
  goog.structs.isEmpty = function (col) {
    return col.isEmpty && typeof col.isEmpty === 'function' ? col.isEmpty() : goog.isArrayLike(col) || goog.isString(col) ? goog.array.isEmpty(col) : goog.object.isEmpty(col)
  }
  goog.structs.clear = function (col) {
    col.clear && typeof col.clear === 'function' ? col.clear() : goog.isArrayLike(col) ? goog.array.clear(col) : goog.object.clear(col)
  }
  ...
  goog.structs.filter = function (col, f, opt_obj) {
    ...
    var rv; var keys = goog.structs.getKeys(col); var values = goog.structs.getValues(col); var l = values.length
    if (keys) {
      rv = {}
      for (var i = 0; i < l; i++) {
  ...
  lf.structs.set.values = function (set) {
    ...
    var i = 0; var array = Array(set.size)
  ...
  lf.backstore.BundledObjectStore.prototype.getPagesByRowIds_ = function (rowIds) {
    var results = lf.structs.map.create(); var resolver = goog.Promise.withResolver(); var pageIds = lf.backstore.Page.toPageIds(rowIds); var promises = pageIds.map(function (id) {
      return new goog.Promise(function (resolve, reject) {
        var request
        try {
  ...
  lf.backstore.BundledObjectStore.prototype.getAll_ = function () {
    return new goog.Promise(function (resolve, reject) {
      ...
      request.onsuccess = function () {
        ...
        if (cursor) {
          var page = lf.backstore.Page.deserialize(cursor.value); var data = page.payload_; var key
          for (key in data) {
  ...
  lf.backstore.BundledObjectStore.prototype.put = function (rows) {
    ...
    rows.forEach(function (row) {
      var pageId = lf.backstore.Page.toPageId(row.id()); var page = pages.get(pageId) || null
  ...
  lf.backstore.BundledObjectStore.prototype.remove = function (ids) {
    ...
    var pages = lf.structs.map.create()
    ids.forEach(function (id) {
      var pageId = lf.backstore.Page.toPageId(id); var page = pages.get(pageId) || null
      goog.isNull(page) && (page = this.retrievePageFn_(this.store_.name, pageId))
      page.removeRows([id])
      pages.set(pageId, page)
    }, this)
    var promises = lf.structs.map.values(pages).map(function (page) {
      return this.performWriteOp_(function () {
        return Object.keys(page.payload_).length == 0 ? this.store_.delete(page.getId()) : this.store_.put(page.serialize())
      }.bind(this))
    }, this)
    return goog.Promise.all(promises)
  }
  lf.backstore.BundledObjectStore.getDataTablePage_ = function (global, tableName, pageId) {
    var cache = global.getService(lf.service.CACHE); var range = lf.backstore.Page.getPageRange(pageId); var rows = cache.getRange(tableName, range[0], range[1]); var page = new lf.backstore.Page(pageId)
    page.setRows(rows)
    return page
  }
  ...
  lf.cache.InMemoryUpdater.prototype.updateIndicesForDiff_ = function (diff) {
    var table = this.schema_.table(diff.getName()); var modifications = diff.getAsModifications()
  ...
  lf.cache.InMemoryUpdater.prototype.updateTableIndicesForRow = function (table, modification) {
    var indices = this.indexStore_.getTableIndices(table.getName()); var updatedIndices = 0
  ...
  lf.cache.InMemoryUpdater.prototype.updateTableIndexForRow_ = function (index, modification) {
    var keyNow = goog.isNull(modification[1]) ? void 0 : modification[1].keyOfIndex(index.getName()); var keyThen = goog.isNull(modification[0]) ? void 0 : modification[0].keyOfIndex(index.getName())
  ...
  lf.structs.MapSet.prototype.delete = function (key, value) {
    ...
    didRemove && (--this.size, valueSet.size == 0 && this.map_.delete(key))
    return didRemove
  }
  ...
  lf.cache.ConstraintChecker.prototype.findExistingRowIdInIndex_ = function (indexSchema, row) {
    var indexName = indexSchema.getNormalizedName(); var indexKey = row.keyOfIndex(indexName); var index = this.indexStore_.get(indexName); var rowIds = index.get(indexKey)
  ...
  lf.cache.ConstraintChecker.prototype.checkReferredKey_ = function (foreignKeySpec, modifications) {
    ...
    modifications.forEach(function (modification) {
      ...
      if (didColumnValueChange) {
        var rowAfter = modification[1]; var parentKey = rowAfter.keyOfIndex(foreignKeySpec.name)
  ...
  lf.cache.ConstraintChecker.prototype.findParentIndex_ = function (foreignKeySpec) {
    var parentTable = this.schema_.table(foreignKeySpec.parentTable); var parentColumn = parentTable[foreignKeySpec.parentColumn]; var parentIndexSchema = parentColumn.getIndex()
  ...
  lf.cache.ConstraintChecker.prototype.checkReferringKeys_ = function (table, modifications, constraintTiming, opt_constraintAction) {
    ...
    }), foreignKeySpecs.length != 0 && this.loopThroughReferringRows_(foreignKeySpecs, modifications, function (foreignKeySpec, childIndex, parentKey) {
  ...
  lf.cache.ConstraintChecker.prototype.findReferringRowIds_ = function (table, modifications) {
    ...
    this.loopThroughReferringRows_(foreignKeySpecs, modifications, function (foreignKeySpec, childIndex, parentKey) {
      ...
      childRowIds.length > 0 && referringRowIds.setMany(foreignKeySpec.childTable, childRowIds)
    })
  ...
  lf.cache.ConstraintChecker.prototype.loopThroughReferringRows_ = function (foreignKeySpecs, modifications, callbackFn) {
    foreignKeySpecs.forEach(function (foreignKeySpec) {
      var childIndex = this.indexStore_.get(foreignKeySpec.name); var parentIndex = this.getParentIndex_(foreignKeySpec)
      modifications.forEach(function (modification) {
        ...
        if (didColumnValueChange) {
          var rowBefore = modification[0]; var parentKey = rowBefore.keyOfIndex(parentIndex.getName())
  ...
  lf.cache.ConstraintChecker.prototype.checkForeignKeysForUpdate = function (table, modifications, constraintTiming) {
    modifications.length != 0 && (this.checkReferredKeys_(table, modifications, constraintTiming), this.checkReferringKeys_(table, modifications, constraintTiming, lf.ConstraintAction.RESTRICT))
  }
  ...
  lf.cache.ConstraintChecker.prototype.detectCascadeDeletion = function (table$jscomp$0, rows) {
    var result = { tableOrder: [], rowIdsPerTable: new lf.structs.MapSet() }; var lastRowIdsToDelete = new lf.structs.MapSet()
    ...
    do {
      ...
      lastRowIdsToDelete.keys().forEach(function (tableName) {
        var table = this.schema_.table(tableName); var rowIds = lastRowIdsToDelete.get(tableName); var modifications = rowIds.map(function (rowId) {
          var row = this.cache_.get(rowId)
          return [row, null]
        }, this); var referringRowIds = this.findReferringRowIds_(table, modifications)
  ...
  lf.cache.TableDiff.prototype.modify = function (modification) {
    var oldValue = modification[0]; var newValue = modification[1]
  ...
  lf.cache.TableDiff.prototype.isEmpty = function () {
    return this.added_.size == 0 && this.deleted_.size == 0 && this.modified_.size == 0
  }
  ...
  lf.cache.Journal.prototype.modifyRow_ = function (table, modification) {
    var tableName = table.getName(); var diff = this.tableDiffs_.get(tableName) || new lf.cache.TableDiff(tableName)
    ...
    var rowBefore = modification[0]; var rowNow = modification[1]
  ...
  lf.cache.Journal.prototype.insertOrReplace = function (table, rows) {
    ...
    this.constraintChecker_.checkNotNullable(table, rows)
    for (var i = 0; i < rows.length; i++) {
      var rowNow = rows[i]; var rowBefore = null; var existingRowId = this.constraintChecker_.findExistingRowIdInPkIndex(table, rowNow)
    ...
    if (!goog.isNull(foreignKeySpecs)) {
      ...
      cascadedUpdates.keys().forEach(function (rowId) {
        ...
        updates.forEach(function (update) {
          var table = this.schema_.table(update.fkSpec.childTable); var rowBefore = this.cache_.get(rowId); var rowAfter = table.deserializeRow(rowBefore.serialize())
  ...
  lf.cache.Journal.prototype.removeByCascade_ = function (table$jscomp$0, rows$jscomp$0) {
    var foreignKeySpecs = this.schema_.info().getReferencingForeignKeys(table$jscomp$0.getName(), lf.ConstraintAction.CASCADE)
    if (!goog.isNull(foreignKeySpecs)) {
      var cascadeDeletion = this.constraintChecker_.detectCascadeDeletion(table$jscomp$0, rows$jscomp$0); var cascadeRowIds = cascadeDeletion.rowIdsPerTable
      cascadeDeletion.tableOrder.forEach(function (tableName) {
        var table = this.schema_.table(tableName); var rows = cascadeRowIds.get(tableName).map(function (rowId) {
  ...
  lf.index.SingleKeyRange.prototype.complement = function () {
    ...
    var keyRangeLow = null; var keyRangeHigh = null
  ...
  lf.index.SingleKeyRange.prototype.overlaps = function (range) {
    ...
    var left = favor == lf.index.Favor.RHS ? this : range; var right = favor == lf.index.Favor.LHS ? this : range
  ...
  lf.index.SingleKeyRange.prototype.contains = function (key) {
    var left = lf.index.SingleKeyRange.isUnbound(this.from) || key > this.from || key == this.from && !this.excludeLower; var right = lf.index.SingleKeyRange.isUnbound(this.to) || key < this.to || key == this.to && !this.excludeUpper
    return left && right
  }
  ...
  lf.index.SingleKeyRange.compareKey_ = function (l, r, isLeftHandSide, opt_excludeL, opt_excludeR) {
    var Favor = lf.index.Favor; var excludeL = opt_excludeL || !1; var excludeR = opt_excludeR || !1; var flip = function (favor) {
  ...
  lf.index.SingleKeyRange.and = function (r1, r2) {
    ...
    var r = lf.index.SingleKeyRange.all(); var favor = lf.index.SingleKeyRange.compareKey_(r1.from, r2.from, !0); var left = favor == lf.index.Favor.TIE ? r1.excludeLower ? r1 : r2 : favor != lf.index.Favor.RHS ? r1 : r2
    r.from = left.from
  ...
  lf.index.SingleKeyRange.complement = function (keyRanges) {
    ...
    for (var complementKeyRanges = Array(keyRanges.length + 1), i = 0; i < complementKeyRanges.length; i++) {
      complementKeyRanges[i] = i == 0 ? lf.index.SingleKeyRange.upperBound(keyRanges[i].from, !0) : i == complementKeyRanges.length - 1 ? lf.index.SingleKeyRange.lowerBound(keyRanges[i - 1].to, !0) : new lf.index.SingleKeyRange(keyRanges[i - 1].to, keyRanges[i].from, !0, !0)
    }
  ...
  lf.index.SingleKeyRangeSet.prototype.equals = function (set) {
    return this.ranges_.length == set.ranges_.length ? this.ranges_.length == 0 || this.ranges_.every(function (r, index) {
  ...
  lf.proc.Relation.fromRows = function (rows, tables) {
    var isPrefixApplied = tables.length > 1; var entries = rows.map(function (row) {
  ...
  lf.proc.RelationEntry.prototype.setField = function (column, value) {
    ...
    if (goog.isDefAndNotNull(alias)) {
      ...
      if (this.isPrefixApplied_) {
        var tableName = column.getTable().getEffectiveName(); var containerObj = this.row.payload_[tableName]
  ...
  lf.proc.RelationEntry.combineEntries = function (leftEntry, leftEntryTables, rightEntry, rightEntryTables) {
    var result = {}; var mergeEntry = function (entry, entryTables) {
      if (entry.isPrefixApplied_) {
        var payload = entry.row.payload_; var prefix
  ...
  lf.eval.buildObjectEvaluatorMap_ = function () {
    var map = lf.structs.map.create(); var checkNull = function (value) {
  ...
  lf.eval.buildDateEvaluatorMap_ = function () {
    ...
    map.set(lf.eval.Type.EQ, function (a, b) {
      var aTime = goog.isNull(a) ? -1 : a.getTime(); var bTime = goog.isNull(b) ? -1 : b.getTime()
      return aTime == bTime
    })
    map.set(lf.eval.Type.GTE, function (a, b) {
  ...
  lf.structs.TreeNode.prototype.addChildAt = function (child, index) {
    ...
    goog.isNull(this.children_) ? (goog.asserts.assert(index == 0), this.children_ = [child]) : (goog.asserts.assert(index >= 0 && index <= this.children_.length), this.children_.splice(index, 0, child))
  }
  ...
  lf.structs.TreeNode.prototype.removeChildAt = function (index) {
    ...
    return child ? (child.setParent(null), this.children_.splice(index, 1), this.children_.length == 0 && (this.children_ = null), child) : null
  }
  ...
  lf.pred.ValuePredicate.prototype.evalAsIn_ = function (relation) {
    ...
    var valueSet = lf.structs.set.create(this.value); var evaluatorFn = function (rowValue) {
      return goog.isNull(rowValue) ? !1 : valueSet.has(rowValue) != this.isComplement_
    }.bind(this); var entries = relation.entries.filter(function (entry) {
  ...
  lf.proc.QueryTask.prototype.exec = function () {
    var journal = this.txType_ == lf.TransactionType.READ_ONLY ? void 0 : new lf.cache.Journal(this.global, this.combinedScope_); var results = []; var remainingPlans = this.plans_.slice(); var queries = this.queries; var sequentiallyExec = function () {
  ...
  lf.proc.ExternalChangeTask = function (global, tableDiffs) {
    ...
    var schema = global.getService(lf.service.SCHEMA); var tableSchemas = this.tableDiffs_.map(function (tableDiff) {
  ...
  lf.backstore.FirebaseRawBackStore.getValue = function (ref, path) {
    var resolver = goog.Promise.withResolver(); var valRef = ref
  ...
  lf.backstore.FirebaseRawBackStore.setValue = function (ref, value, opt_overwrite) {
    var overwrite = opt_overwrite || !1; var resolver = goog.Promise.withResolver(); var handler = function (e) {
  ...
  lf.backstore.FirebaseRawBackStore.prototype.transform_ = function (tableName, callback) {
    ...
    var getRowUpdates = function () {
      var toUpdate = {}; var resolver = goog.Promise.withResolver()
  ...
  lf.backstore.FirebaseRawBackStore.prototype.dumpTable_ = function (tableName) {
    var resolver = goog.Promise.withResolver(); var tableId = this.tableIds_.get(tableName)
    this.db_.orderByChild('T').equalTo(tableId).once('value', function (snapshot) {
      var values = []
      snapshot.forEach(function (row) {
  ...
  lf.backstore.FirebaseRawBackStore.prototype.dump = function () {
    var contents = {}; var promises = lf.structs.map.keys(this.tableIds_).map(function (tableName) {
  ...
  lf.backstore.FirebaseTx.prototype.commitInternal = function () {
    ...
    var diffs = this.journal_.tableDiffs_; var numTableAffected = diffs.size
  ...
  lf.backstore.MemoryTable.prototype.removeSync = function (ids) {
    ids.length == 0 || ids.length == this.data_.size ? this.data_.clear() : ids.forEach(function (id) {
  ...
  lf.backstore.MemoryTable.prototype.getMaxRowId = function () {
    return this.data_.size == 0 ? 0 : lf.structs.map.keys(this.data_).reduce(function (prev, cur) {
  ...
  lf.backstore.Firebase.prototype.init = function (opt_onUpgrade) {
    ...
    var getValue = lf.backstore.FirebaseRawBackStore.getValue; var onUpgrade = opt_onUpgrade || function () {
      return goog.Promise.resolve()
    }
  ...
  lf.backstore.Firebase.prototype.onRemoved_ = function (snapshot) {
    var row = snapshot.val(); var set = this.removedRows_.get(row.T) || null
  ...
  lf.backstore.Firebase.prototype.onChange_ = function (snapshot) {
    ...
    if (goog.isDefAndNotNull(rev) && rev != this.revision_) {
      ...
      diffs.forEach(function (diff) {
        var table = this.tables_.get(diff.getName()); var toRemove = lf.structs.map.keys(diff.deleted_)
        toRemove.length > 0 && table.removeSync(toRemove)
      ...
      diffs.length > 0 && this.notify(diffs)
      this.listen_()
    }
  }
  lf.backstore.Firebase.prototype.generateDiff_ = function (snapshot) {
    var removedIds = lf.structs.set.create(); var diffs = lf.structs.map.create()
    this.tableIds_.forEach(function (tid, tableName) {
      var table = this.tables_.get(tableName); var diff = new lf.cache.TableDiff(tableName)
    ...
    snapshot.forEach(function (child) {
      if (child.key() != '@rev') {
        ...
        if (!removedIds.has(rowId)) {
          var row = child.val(); var diff = diffs.get(row.T); var table = this.tables_.get(diff.getName()); var tableSchema = this.schema_.table(diff.getName()); var nowRow = tableSchema.deserializeRow({ id: rowId, value: row.P })
  ...
  lf.backstore.Firebase.prototype.reloadTable = function (tableName) {
    var resolver = goog.Promise.withResolver(); var tid = this.getTableId(tableName); var tableSchema = this.schema_.table(tableName)
    this.db_.orderByChild('T').equalTo(tid).once('value', function (snapshot) {
      var memTable = new lf.backstore.MemoryTable(); var rows = []
  ...
  lf.backstore.IndexedDBRawBackStore.prototype.transformRows_ = function (tableName, rowFn) {
    var loopFunc = function (cursor) {
      ...
      var page = lf.backstore.Page.deserialize(cursor.value); var data = page.payload_; var rowId
      for (rowId in data) {
  ...
  lf.backstore.IndexedDB.prototype.onUpgradeNeeded_ = function (onUpgrade, ev) {
    var db = ev.target.result; var tx = ev.target.transaction; var rawDb = new lf.backstore.IndexedDBRawBackStore(ev.oldVersion, db, tx, this.bundledMode_)
  ...
  lf.backstore.IndexedDB.prototype.removeIndexTables_ = function (db) {
    for (var storeNames = [], i = 0; i < db.objectStoreNames.length; ++i) {
      ...
      name.indexOf('.') != -1 && storeNames.push(name)
    }
  ...
  lf.backstore.IndexedDB.prototype.scanRowId_ = function (opt_tx) {
    var tableNames = this.schema_.tables().map(function (table) {
    ...
    }); var db = this.db_; var maxRowId = 0; var extractRowId = function (cursor) {
      ...
      return cursor.key
    }.bind(this); var scanTableRowId = function (tableName) {
      return new goog.Promise(function (resolve, reject) {
        var req
        try {
  ...
  lf.backstore.LocalStorageTable.prototype.get = function (ids) {
    var results
    ids.length == 0 ? results = Object.keys(this.data_).map(function (key) {
  ...
  lf.backstore.LocalStorageTable.prototype.remove = function (ids) {
    ids.length == 0 || ids.length == Object.keys(this.data_).length ? this.data_ = {} : ids.forEach(function (id) {
  ...
  lf.backstore.LocalStorageTable.prototype.diff = function (newData) {
    var oldIds = Object.keys(this.data_); var newIds = Object.keys(newData); var diff = new lf.cache.TableDiff(this.key_)
  ...
  lf.backstore.LocalStorage.prototype.initSync = function () {
    ...
    var versionKey = this.schema_.name() + '.version#'; var version = window.localStorage.getItem(versionKey)
  ...
  lf.backstore.LocalStorage.prototype.onStorageEvent_ = function (raw) {
    ...
    if (ev.storageArea == window.localStorage && ev.key.indexOf(this.schema_.name() + '.') == 0) {
      var newValue = window.localStorage.getItem(ev.key); var newData = {}
      ...
      var tableName = ev.key.slice(this.schema_.name().length + 1); var table = this.tables_.get(tableName)
  ...
  lf.backstore.WebSqlTable.prototype.get = function (ids) {
    var where = ids.length == 0 ? '' : 'WHERE id IN (' + ids.join(',') + ')'; var sql = 'SELECT id, value FROM ' + this.name_ + ' ' + where; var deserializeFn = this.deserializeFn_; var transformer = function (results) {
  ...
  lf.backstore.WebSqlTable.prototype.remove = function (ids) {
    var where = ids.length == 0 ? '' : 'WHERE id IN (' + ids.join(',') + ')'; var sql = 'DELETE FROM ' + this.name_ + ' ' + where
    this.tx_.queue(sql, [])
    return goog.Promise.resolve()
  }
  ...
  lf.backstore.WebSqlTx.prototype.commitInternal = function () {
    var lastCommand = null; var onTxError = this.resolver.reject.bind(this.resolver); var onExecError = function (tx, e) {
      this.resolver.reject(e)
    }.bind(this); var results = []; var callback = function (tx, opt_results) {
  ...
  lf.backstore.WebSqlRawBackStore.prototype.transformColumn_ = function (tableName, transformer) {
    var tx = this.createTx_(); var sql = 'UPDATE ' + tableName + ' SET value=? WHERE id=?'
    return this.dumpTable_(tableName).then(function (rows) {
      rows.forEach(function (row) {
  ...
  lf.backstore.WebSqlRawBackStore.prototype.dump = function () {
    var resolver = goog.Promise.withResolver(); var tx = this.createTx_()
  ...
  lf.backstore.WebSql.prototype.checkVersion_ = function (onUpgrade) {
    var resolver = goog.Promise.withResolver(); var tx = new lf.backstore.WebSqlTx(this.db_, lf.TransactionType.READ_WRITE, this.getEmptyJournal_())
  ...
  lf.backstore.WebSql.prototype.preUpgrade_ = function () {
    var tables = this.schema_.tables(); var tx = new lf.backstore.WebSqlTx(this.db_, lf.TransactionType.READ_WRITE, this.getEmptyJournal_()); var tx2 = new lf.backstore.WebSqlTx(this.db_, lf.TransactionType.READ_WRITE, this.getEmptyJournal_())
    ...
    return tx.commit().then(function (results) {
      ...
      var newTables = []; var persistentIndices = []; var rowIdIndices = []
      tables.map(function (table) {
        existingTables.indexOf(table.getName()) == -1 && newTables.push(table.getName())
        if (table.persistentIndex) {
  ...
  lf.backstore.WebSql.prototype.scanRowId_ = function () {
    var maxRowId = 0; var resolver = goog.Promise.withResolver(); var selectIdFromTable = function (tableName) {
    ...
    }.bind(this); var promises = this.schema_.tables().map(function (table) {
  ...
  lf.cache.DefaultCache.prototype.getRange = function (tableName, fromId, toId) {
    var data = []; var min = Math.min(fromId, toId); var max = Math.max(fromId, toId); var tableSet = this.tableRows_.get(tableName)
  ...
  lf.structs.array.binarySearch_ = function (arr, value, opt_comparator) {
    for (var left = 0, right = arr.length, comparator = opt_comparator || lf.structs.array.defaultComparator_; left < right;) {
      ...
      comparator(arr[middle], value) < 0 ? left = middle + 1 : right = middle
    }
  ...
  lf.structs.array.binaryInsert = function (arr, value, opt_comparator) {
    ...
    return index < 0 ? (arr.splice(-(index + 1), 0, value), !0) : !1
  }
  ...
  lf.index.BTree.prototype.getAll_ = function (maxCount, reverse, limit, skip) {
    var offset = reverse ? this.stats_.totalRows - maxCount - skip : skip; var results = Array(maxCount); var params = { offset: offset, count: maxCount, startIndex: 0 }
  ...
  lf.index.BTree.prototype.getRange = function (opt_keyRanges, opt_reverseOrder, opt_limit, opt_skip) {
    ...
    var reverse = opt_reverseOrder || !1; var limit = goog.isDefAndNotNull(opt_limit) ? Math.min(opt_limit, this.stats_.totalRows) : this.stats_.totalRows; var skip = opt_skip || 0; var maxCount = Math.min(Math.max(this.stats_.totalRows - skip, 0), limit)
    if (maxCount == 0) {
      return lf.index.BTree.EMPTY
    }
    if (!goog.isDef(opt_keyRanges) || opt_keyRanges.length == 1 && opt_keyRanges[0] instanceof lf.index.SingleKeyRange && opt_keyRanges[0].isAll()) {
      return this.getAll_(maxCount, reverse, limit, skip)
    }
    var sortedKeyRanges = this.comparator_.sortKeyRanges(opt_keyRanges); var results = Array(reverse ? this.stats_.totalRows : maxCount); var params = { count: 0, limit: results.length, reverse: reverse, skip: skip }; var useFilter = this.comparator().keyDimensions() > 1
    sortedKeyRanges.forEach(function (range) {
      for (var keys = this.comparator_.rangeToKeys(range), key = this.comparator_.isLeftOpen(range) ? leftMostKey : keys[0], start = this.root_.getContainingLeaf(key), strikeCount = 0; goog.isDefAndNotNull(start) && params.count < params.limit;) {
        useFilter ? start.getRangeWithFilter(range, params, results) : start.getRange(range, params, results), params.skip != 0 || start.isFirstKeyInRange(range) ? strikeCount = 0 : strikeCount++, start = strikeCount == 2 ? null : start.next()
      }
    }, this)
  ...
  lf.index.BTree.prototype.findLeftMost_ = function () {
    var node = this.root_.getLeftMostNode(); var index = 0
    do {
  ...
  lf.index.BTree.prototype.findRightMost_ = function () {
    var node = this.root_.getRightMostNode(); var index = node.keys_.length - 1
    do {
      if (index < 0) {
  ...
  lf.index.BTree.prototype.minMax_ = function (compareFn) {
    var leftMost = this.findLeftMost_(); var rightMost = this.findRightMost_()
  ...
  lf.index.BTree.deserialize = function (comparator, name, uniqueKeyOnly, rows) {
    var tree = new lf.index.BTree(name, comparator, uniqueKeyOnly); var newRoot = lf.index.BTreeNode_.deserialize(rows, tree)
    tree.root_ = newRoot
    return tree
  }
  lf.index.BTreeNode_ = function (id, tree) {
    ...
    this.values_ = []
    this.children_ = []
    this.getContainingLeaf = tree.comparator().keyDimensions() == 1 ? this.getContainingLeaf_ : this.getContainingLeafMultiKey_
  }
  ...
  lf.index.BTreeNode_.dumpLevel_ = function (node$jscomp$0) {
    var key = node$jscomp$0.id_ + '[' + node$jscomp$0.keys_.join('|') + ']'; var childrenIds = node$jscomp$0.children_.map(function (n) {
      return n.id_
    }); var children = childrenIds.join('|'); var values = node$jscomp$0.values_.join('/'); var getNodeId = function (node) {
      return goog.isDefAndNotNull(node) ? node.id_.toString() : '_'
    }; var contents = getNodeId(node$jscomp$0.prev_) + '{'; var contents = node$jscomp$0.isLeaf_() ? contents + values : contents + children; var contents = contents + '}' + getNodeId(node$jscomp$0.parent_)
    if (node$jscomp$0.next_) {
      var next = lf.index.BTreeNode_.dumpLevel_(node$jscomp$0.next_); var key = key + '  ' + next[0]; var contents = contents + '  ' + next[1]
    }
    return [key, contents]
  }
  lf.index.BTreeNode_.prototype.toString = function () {
    var result = ''; var level = lf.index.BTreeNode_.dumpLevel_(this); var result = result + (level[0] + '\n' + level[1] + '\n')
  ...
  lf.index.BTreeNode_.calcNodeLen_ = function (remaining) {
    var maxLen = lf.index.BTreeNode_.MAX_KEY_LEN_; var minLen = lf.index.BTreeNode_.MIN_KEY_LEN_ + 1
  ...
  lf.index.BTreeNode_.createLeaves_ = function (tree, data) {
    for (var remaining = data.length, dataIndex = 0, curNode = lf.index.BTreeNode_.create(tree), node = curNode; remaining > 0;) {
      var nodeLen = lf.index.BTreeNode_.calcNodeLen_(remaining); var target = data.slice(dataIndex, dataIndex + nodeLen)
  ...
  lf.index.BTreeNode_.createParent_ = function (nodes) {
    var node = nodes[0]; var root = lf.index.BTreeNode_.create(node.tree_)
    root.height_ = node.height_ + 1
    root.children_ = nodes
    for (var i = 0; i < nodes.length; ++i) {
      nodes[i].parent_ = root, i > 0 && root.keys_.push(nodes[i].keys_[0])
    }
    return root
  }
  lf.index.BTreeNode_.createInternals_ = function (node) {
    var curNode = node; var data = []
    do {
    ...
    if (data.length <= lf.index.BTreeNode_.MAX_KEY_LEN_ + 1) {
      ...
      var remaining = data.length; var dataIndex = 0
      root = lf.index.BTreeNode_.create(node.tree_)
      for (root.height_ = node.height_ + 2; remaining > 0;) {
        var nodeLen = lf.index.BTreeNode_.calcNodeLen_(remaining); var target = data.slice(dataIndex, dataIndex + nodeLen); var newNode = lf.index.BTreeNode_.createParent_(target)
  ...
  lf.index.BTreeNode_.fromData = function (tree, data) {
    var max = lf.index.BTreeNode_.MAX_KEY_LEN_; var max = max * max * max
    if (data.length >= max) {
  ...
  lf.index.BTreeNode_.prototype.remove = function (key, opt_value) {
    ...
    if (this.isRoot_()) {
      var root = this
      this.children_.length == 1 && (root = this.children_[0], root.parent_ = null)
      return root
    }
    return this
  }
  ...
  lf.index.BTreeNode_.prototype.delete_ = function (key, parentPos, opt_value) {
    var pos = this.searchKey_(key); var isLeaf = this.isLeaf_()
    if (!isLeaf) {
  ...
  lf.index.BTreeNode_.prototype.steal_ = function () {
    ...
    var child = this.isLeaf_() ? this.values_ : this.children_; var fromChild
  ...
  lf.index.BTreeNode_.prototype.merge_ = function (parentPos) {
    ...
    parentPos != -1 && (this.parent_.keys_.splice(parentPos, 1), this.parent_.children_.splice(parentPos, 1))
  }
  lf.index.BTreeNode_.prototype.insert = function (key, value, opt_replace) {
    ...
    var pos = this.tree_.eq(this.keys_[pos], key) ? pos + 1 : pos; var node = this.children_[pos].insert(key, value, opt_replace)
    node.isLeaf_() || node.keys_.length != 1 || (this.keys_.splice(pos, 0, node.keys_[0]), node.children_[1].parent_ = this, node.children_[0].parent_ = this, this.children_.splice(pos, 1, node.children_[1]), this.children_.splice(pos, 0, node.children_[0]))
  ...
  lf.index.BTreeNode_.prototype.splitLeaf_ = function () {
    var half = lf.index.BTreeNode_.MIN_KEY_LEN_; var right = lf.index.BTreeNode_.create(this.tree_); var root = lf.index.BTreeNode_.create(this.tree_)
    root.height_ = 1
  ...
  lf.index.BTreeNode_.prototype.splitInternal_ = function () {
    var half = lf.index.BTreeNode_.MIN_KEY_LEN_; var root = lf.index.BTreeNode_.create(this.tree_); var right = lf.index.BTreeNode_.create(this.tree_)
    root.parent_ = this.parent_
  ...
  lf.index.BTreeNode_.prototype.getRange = function (keyRange, params, results) {
    var c = this.tree_.comparator(); var left = 0; var right = this.keys_.length - 1; var compare = function (coverage) {
      return coverage[0] ? coverage[1] ? lf.index.Favor.TIE : lf.index.Favor.LHS : lf.index.Favor.RHS
    }; var keys = this.keys_; var favorLeft = compare(c.compareRange(keys[left], keyRange)); var favorRight = compare(c.compareRange(keys[right], keyRange))
    if (favorLeft != lf.index.Favor.LHS && (favorLeft != lf.index.Favor.RHS || favorRight != lf.index.Favor.RHS)) {
      ...
      left != -1 && (right = findLastKey(left, right), right != -1 && right >= left && this.appendResults_(params, results, left, right + 1))
    }
  }
  ...
  lf.index.BTreeNode_.prototype.fill = function (params, results) {
    if (this.isLeaf_()) {
      for (var i = 0; i < this.values_.length && params.count > 0; ++i) {
        if (params.offset > 0) {
          if (params.offset -= this.tree_.isUniqueKey() ? 1 : this.values_[i].length, params.offset < 0) {
            for (var j = this.values_[i].length + params.offset; j < this.values_[i].length && params.count > 0; ++j) {
          ...
          if (this.tree_.isUniqueKey()) {
            ...
            for (j = 0; j < this.values_[i].length && params.count > 0; ++j) {
              results[params.startIndex++] = this.values_[i][j], params.count--
            }
          }
        }
      ...
      for (i = 0; i < this.children_.length && params.count > 0; ++i) {
  ...
  lf.index.SimpleComparator.prototype.compareRange = function (key, naturalRange) {
    var range = this.normalizeKeyRange_(naturalRange); var results = [lf.index.SingleKeyRange.isUnbound(range.from), lf.index.SingleKeyRange.isUnbound(range.to)]
    if (!results[0]) {
  ...
  lf.index.MultiKeyComparator.prototype.rangeToKeys = function (keyRange) {
    ...
    }, this); var endKey = keyRange.map(function (range, i) {
  ...
  lf.index.NullableIndex.prototype.containsKey = function (key) {
    return goog.isNull(key) ? this.nulls_.size != 0 : this.index_.containsKey(key)
  }
  ...
  lf.index.NullableIndex.deserialize = function (deserializeFn, rows) {
    ...
    var nulls = rows[index].payload_; var newRows = rows.slice(0)
    newRows.splice(index, 1)
    var tree = deserializeFn(newRows); var nullableIndex = new lf.index.NullableIndex(tree)
  ...
  lf.index.RowId.prototype.getRange = function (opt_keyRanges, opt_reverseOrder, opt_limit, opt_skip) {
    var keyRanges = opt_keyRanges || [lf.index.SingleKeyRange.all()]; var values = lf.structs.set.values(this.rows_).filter(function (value) {
  ...
  lf.index.RowId.deserialize = function (name, rows) {
    var index = new lf.index.RowId(name); var rowIds = rows[0].payload_
    rowIds.forEach(function (rowId) {
  ...
  lf.cache.Prefetcher.prototype.init = function (schema) {
    var tables = schema.tables(); var execSequentially = function () {
      if (tables.length == 0) {
        return goog.Promise.resolve()
      }
      var table = tables.shift(); var whenTableFetched = table.persistentIndex() ? this.fetchTableWithPersistentIndices_(table) : this.fetchTable_(table)
  ...
  lf.cache.Prefetcher.prototype.fetchTable_ = function (table) {
    var tx = this.backStore_.createTx(lf.TransactionType.READ_ONLY, [table]); var store = tx.getTable(table.getName(), table.deserializeRow.bind(table), lf.backstore.TableType.DATA); var promise = store.get([]).then(function (results) {
  ...
  lf.cache.Prefetcher.prototype.fetchTableWithPersistentIndices_ = function (tableSchema) {
    var tx = this.backStore_.createTx(lf.TransactionType.READ_ONLY, [tableSchema]); var store = tx.getTable(tableSchema.getName(), tableSchema.deserializeRow, lf.backstore.TableType.DATA); var whenTableContentsFetched = store.get([]).then(function (results) {
      this.cache_.setMany(tableSchema.getName(), results)
    }.bind(this)); var whenIndicesReconstructed = tableSchema.getIndices().map(function (indexSchema) {
  ...
  lf.cache.Prefetcher.prototype.reconstructPersistentIndex_ = function (indexSchema, tx) {
    var indexTable = tx.getTable(indexSchema.getNormalizedName(), lf.Row.deserialize, lf.backstore.TableType.INDEX); var comparator = lf.index.ComparatorFactory.create(indexSchema)
    return indexTable.get([]).then(function (serializedRows) {
      if (serializedRows.length > 0) {
        if (indexSchema.hasNullableColumn()) {
          var deserializeFn = lf.index.BTree.deserialize.bind(void 0, comparator, indexSchema.getNormalizedName(), indexSchema.isUnique); var nullableIndex = lf.index.NullableIndex.deserialize(deserializeFn, serializedRows)
  ...
  lf.index.MemoryIndexStore.prototype.init = function (schema) {
    ...
    tables.forEach(function (table) {
      ...
      var rowIdIndexName = table.getRowIdIndexName(); var rowIdIndex = this.get(rowIdIndexName)
  ...
  lf.index.MemoryIndexStore.createIndex_ = function (indexSchema) {
    var comparator = lf.index.ComparatorFactory.create(indexSchema); var index = new lf.index.BTree(indexSchema.getNormalizedName(), comparator, indexSchema.isUnique)
    return indexSchema.hasNullableColumn() && indexSchema.columns.length == 1 ? new lf.index.NullableIndex(index) : index
  }
  ...
  lf.index.MemoryIndexStore.prototype.set = function (tableName, index) {
    ...
    !goog.isNull(existsAt) && tableIndices.length > 0 ? tableIndices.splice(existsAt, 1, index) : tableIndices.push(index)
  ...
  lf.tree.map = function (original, mapFn) {
    var copyParentStack = []; var nextParent = null; var copyRoot = null
    original.traverse(function (node) {
      var newNode = mapFn(node)
      node.getParent() == null ? copyRoot = newNode : nextParent.addChild(newNode)
      var original = node.getParent(); var clone = nextParent
      if (!goog.isNull(original)) {
        ...
        if (cloneFull) {
          ...
          cloneIndex != -1 && copyParentStack.splice(cloneIndex, 1)
        }
      }
      node.getChildCount() > 1 && copyParentStack.push(newNode)
  ...
  lf.tree.removeNode = function (node) {
    var parentNode = node.getParent(); var originalIndex = 0
  ...
  lf.tree.pushNodeBelowChild = function (node, shouldPushDownFn, cloneFn) {
    ...
    var child = node.getChildAt(0)
    goog.asserts.assert(child.getChildCount() > 1)
    var grandChildren = child.getChildren().slice(); var canPushDown = grandChildren.some(function (grandChild) {
  ...
  lf.tree.find = function (root, filterFn, opt_stopFn) {
    var results = []; var filterRec = function (node) {
  ...
  lf.pred.JoinPredicate.prototype.eval = function (relation) {
    var entries = relation.entries.filter(function (entry) {
      var leftValue = entry.getField(this.leftColumn); var rightValue = entry.getField(this.rightColumn)
  ...
  lf.pred.JoinPredicate.prototype.createCombinedEntryForUnmatched_ = function (entry, leftRelationTables) {
    ...
    var nullEntry = new lf.proc.RelationEntry(new lf.Row(lf.Row.DUMMY_ID, this.nullPayload_), !1); var combinedEntry = lf.proc.RelationEntry.combineEntries(entry, leftRelationTables, nullEntry, [this.rightColumn.getTable().getEffectiveName()])
  ...
  lf.pred.JoinPredicate.prototype.evalRelationsNestedLoopJoin = function (leftRelation, rightRelation, isOuterJoin) {
    ...
    for (var combinedEntries = [], leftRelationTables = leftRelation.getTables(), rightRelationTables = rightRelation.getTables(), leftEntriesLength = leftRelation.entries.length, rightEntriesLength = rightRelation.entries.length, blockNumBits = lf.pred.JoinPredicate.BLOCK_SIZE_EXPONENT_, blockCount = rightEntriesLength + (1 << blockNumBits) - 1 >> blockNumBits, currentBlock = 0; currentBlock < blockCount;) {
      for (var i = 0; i < leftEntriesLength; i++) {
        var matchFound = !1; var leftValue = leftRelation.entries[i].getField(this.leftColumn)
        if (!goog.isNull(leftValue)) {
          for (var rightLimit = Math.min(currentBlock + 1 << blockNumBits, rightEntriesLength), j = currentBlock << blockNumBits; j < rightLimit; j++) {
            ...
            if (predicateResult) {
              var matchFound = !0; var combinedEntry = lf.proc.RelationEntry.combineEntries(leftRelation.entries[i], leftRelationTables, rightRelation.entries[j], rightRelationTables)
  ...
  lf.pred.JoinPredicate.prototype.evalRelationsHashJoin = function (leftRelation, rightRelation, isOuterJoin) {
    ...
    leftRelation = leftRightRelations[0]
    rightRelation = leftRightRelations[1]
    var minRelation = leftRelation; var maxRelation = rightRelation; var minColumn = this.leftColumn; var maxColumn = this.rightColumn
    isOuterJoin && (minRelation = rightRelation, maxRelation = leftRelation, minColumn = this.rightColumn, maxColumn = this.leftColumn)
    var map = new lf.structs.MapSet(); var combinedEntries = []
    minRelation.entries.forEach(function (entry) {
      var key = String(entry.getField(minColumn))
      map.set(key, entry)
    })
    var minRelationTableNames = minRelation.getTables(); var maxRelationTableNames = maxRelation.getTables()
    maxRelation.entries.forEach(function (entry) {
      var value = entry.getField(maxColumn); var key = String(value)
  ...
  lf.pred.JoinPredicate.prototype.evalRelationsIndexNestedLoopJoin = function (leftRelation, rightRelation, indexJoinInfo, cache) {
    ...
    var indexedTable = indexJoinInfo.indexedColumn.getTable(); var outerRelation = leftRelation; var innerRelation = rightRelation
    leftRelation.getTables().indexOf(indexedTable.getEffectiveName()) != -1 && (outerRelation = rightRelation, innerRelation = leftRelation)
    var combinedEntries = []; var innerRelationTables = innerRelation.getTables(); var outerRelationTables = outerRelation.getTables(); var pushCombinedEntry = function (outerEntry, row) {
      var innerEntry = new lf.proc.RelationEntry(row, innerRelationTables.length > 1); var combinedEntry = lf.proc.RelationEntry.combineEntries(outerEntry, outerRelationTables, innerEntry, innerRelationTables)
      combinedEntries.push(combinedEntry)
    }
    outerRelation.entries.forEach(function (entry) {
      var keyOfIndex = this.keyOfIndexFn_(entry.getField(indexJoinInfo.nonIndexedColumn)); var matchingRowIds = indexJoinInfo.index.get(keyOfIndex)
  ...
  lf.proc.AggregationStep.Calculator_.prototype.calculate = function () {
    this.columns_.forEach(function (column) {
      for (var reverseColumnChain = column.getColumnChain().reverse(), i = 1; i < reverseColumnChain.length; i++) {
        var currentColumn = reverseColumnChain[i]; var leafColumn = currentColumn.getColumnChain().slice(-1)[0]; var inputRelation = this.getInputRelationFor_(currentColumn)
  ...
  lf.proc.AggregationStep.Calculator_.evalAggregation_ = function (aggregatorType, relation, column) {
    var result = null; var Calculator = lf.proc.AggregationStep.Calculator_
    switch (aggregatorType) {
      ...
      case lf.fn.Type.AVG:
        ...
        count > 0 && (result = Calculator.sum_(relation, column) / count)
        break
  ...
  lf.proc.AggregationStep.Calculator_.stddev_ = function (relation, column) {
    ...
    return values.length == 0 ? null : goog.math.standardDeviation.apply(null, values)
  }
  lf.proc.AggregationStep.Calculator_.geomean_ = function (relation, column) {
    var nonZeroEntriesCount = 0; var reduced = relation.entries.reduce(function (soFar, entry) {
      var value = entry.getField(column)
  ...
  lf.proc.ProjectNode.prototype.toString = function () {
    ...
    if (!goog.isNull(this.groupByColumns)) {
      ...
      }).join(', '); var string = string + (', groupBy(' + groupBy + ')')
    }
    return string += ')'
  }
  ...
  lf.proc.AndPredicatePass.prototype.traverse_ = function (rootNode) {
    if (rootNode instanceof lf.proc.SelectNode) {
      ...
      var predicates = this.breakAndPredicate_(rootNode.predicate); var newNodes = this.createSelectNodeChain_(predicates)
  ...
  lf.proc.AndPredicatePass.prototype.createSelectNodeChain_ = function (predicates) {
    var parentNode = null; var lastNode = null
  ...
  lf.proc.CrossProductPass.prototype.traverse_ = function (rootNode) {
    if (rootNode instanceof lf.proc.CrossProductNode) {
      for (;rootNode.getChildCount() > 2;) {
        for (var crossProduct = new lf.proc.CrossProductNode(), i = 0; i < 2; i++) {
  ...
  lf.query.DeleteContext.prototype.expandTableScope_ = function (tableName, scopeSoFar) {
    var cascadeChildTables = this.schema.info().getChildTables(tableName, lf.ConstraintAction.CASCADE); var childTables = this.schema.info().getChildTables(tableName)
  ...
  lf.query.UpdateContext.prototype.bind = function (values) {
    ...
    this.set.forEach(function (set) {
      set.binding != -1 && (set.value = values[set.binding])
    })
    this.bindValuesInSearchCondition(values)
    return this
  }
  ...
  lf.query.insertToSql_ = function (query, stripValueInfo) {
    var prefix = query.allowReplace ? 'INSERT OR REPLACE' : 'INSERT'; var columns = query.into.getColumns(); var prefix = prefix + (' INTO ' + query.into.getName() + '('); var prefix = prefix + columns.map(function (col) {
      return col.getName()
    }).join(', '); var prefix = prefix + ') VALUES ('; var sqls = query.values.map(function (row) {
  ...
  lf.query.valueToSql_ = function (value, op, type, stripValueInfo) {
    ...
    if (op == lf.eval.Type.IN) {
      var array = value; var vals = array.map(function (e) {
  ...
  lf.query.valuePredicateToSql_ = function (pred, stripValueInfo) {
    var column = pred.column.getNormalizedName(); var op = lf.query.evaluatorToSql_(pred.evaluatorType); var value = lf.query.valueToSql_(pred.value, pred.evaluatorType, pred.column.getType(), stripValueInfo)
    return op == '=' && value == 'NULL' ? [column, 'IS NULL'].join(' ') : op == '<>' && value == 'NULL' ? [column, 'IS NOT NULL'].join(' ') : [column, op, value].join(' ')
  }
  ...
  lf.query.updateToSql_ = function (query, stripValueInfo) {
    var sql = 'UPDATE ' + query.table.getName() + ' SET '; var sql = sql + query.set.map(function (set) {
      var setter = set.column.getNormalizedName() + ' = '
      return set.binding != -1 ? setter + '?' + set.binding.toString() : setter + lf.query.escapeSqlValue_(set.column.getType(), set.value).toString()
    }).join(', ')
    query.where && (sql += lf.query.predicateToSql_(query.where, stripValueInfo))
    return sql += ';'
  }
  lf.query.selectToSql_ = function (query, stripValueInfo) {
    ...
    goog.isDefAndNotNull(query.outerJoinPredicates) && query.outerJoinPredicates.size != 0 ? sql += lf.query.getFromListForOuterJoin_(query, stripValueInfo) : (sql += lf.query.getFromListForInnerJoin_(query, stripValueInfo), query.where && (sql += lf.query.predicateToSql_(query.where, stripValueInfo)))
    if (query.orderBy) {
      var orderBy = query.orderBy.map(function (order) {
        return order.column.getNormalizedName() + (order.order == lf.Order.DESC ? ' DESC' : ' ASC')
      }).join(', '); var sql = sql + (' ORDER BY ' + orderBy)
    }
    if (query.groupBy) {
      var groupBy = query.groupBy.map(function (col) {
        return col.getNormalizedName()
      }).join(', '); var sql = sql + (' GROUP BY ' + groupBy)
    }
  ...
  lf.query.getFromListForOuterJoin_ = function (query, stripValueInfo) {
    for (var retrievedNodes = lf.tree.find(query.where, function (node) {
      ...
      var fromName = lf.query.getTableNameToSql_(query.from[i]); var fromList = query.outerJoinPredicates.has(retrievedNodes[predicateString.length - i].getId()) ? fromList + (' LEFT OUTER JOIN ' + fromName) : fromList + (' INNER JOIN ' + fromName); var fromList = fromList + (' ON (' + predicateString[predicateString.length - i] + ')')
    }
    var node$jscomp$0 = query.where; var leftChild = node$jscomp$0.getChildCount() > 0 ? node$jscomp$0.getChildAt(0) : node$jscomp$0
  ...
  lf.query.toSql = function (builder, opt_stripValueInfo) {
    var stripValueInfo = opt_stripValueInfo || !1; var query = builder.getQuery()
  ...
  lf.query.SelectBuilder.prototype.checkDistinctColumn_ = function () {
    ...
    }, this); var isValidCombination = distinctColumns.length == 0 || distinctColumns.length == 1 && this.query.columns.length == 1
  ...
  lf.query.SelectBuilder.prototype.checkProjectionListNotMixed_ = function () {
    ...
    }, this); var nonAggregatedColumnsExist = this.query.columns.some(function (column) {
      return !(column instanceof lf.fn.AggregatedColumn)
  ...
  lf.proc.UpdateLogicalPlanGenerator.prototype.generateInternal = function () {
    var updateNode = new lf.proc.UpdateNode(this.query.table); var selectNode = goog.isDefAndNotNull(this.query.where) ? new lf.proc.SelectNode(this.query.where.copy()) : null; var tableAccessNode = new lf.proc.TableAccessNode(this.query.table)
  ...
  lf.proc.DeleteLogicalPlanGenerator.prototype.generateInternal = function () {
    var deleteNode = new lf.proc.DeleteNode(this.query.from); var selectNode = goog.isDefAndNotNull(this.query.where) ? new lf.proc.SelectNode(this.query.where.copy()) : null; var tableAccessNode = new lf.proc.TableAccessNode(this.query.from)
  ...
  lf.proc.ImplicitJoinsPass.prototype.traverse_ = function (rootNode, queryContext) {
    if (rootNode instanceof lf.proc.SelectNode && rootNode.predicate instanceof lf.pred.JoinPredicate) {
      goog.asserts.assert(rootNode.getChildCount() == 1, 'SelectNode must have exactly one child.')
      var predicateId = rootNode.predicate.getId(); var child$jscomp$0 = rootNode.getChildAt(0)
      if (child$jscomp$0 instanceof lf.proc.CrossProductNode) {
        var isOuterJoin = goog.isDefAndNotNull(queryContext.outerJoinPredicates) && queryContext.outerJoinPredicates.has(predicateId); var joinNode = new lf.proc.JoinNode(rootNode.predicate, isOuterJoin)
    ...
    var processChildren = function (node) {
      ...
      if (!this.alreadyPushedDown_.has(node)) {
        if (this.isCandidateNode_(node)) {
          var selectNode = node; var selectNodeTables = selectNode.predicate.getTables(); var shouldPushDownFn = function (child) {
            return this.doesReferToTables_(child, selectNodeTables)
          }.bind(this); var newRoot = this.pushDownNodeRec_(queryContext, selectNode, shouldPushDownFn)
  ...
  lf.proc.PushDownSelectionsPass.prototype.pushDownNodeRec_ = function (queryContext, node$jscomp$0, shouldPushDownFn) {
    ...
    if (this.shouldSwapWithChild_(queryContext, node$jscomp$0)) {
      ...
      if (this.shouldPushBelowChild_(node$jscomp$0)) {
        var newNodes = []; var cloneFn = function (node) {
          var newNode = new lf.proc.SelectNode(node.predicate)
          newNodes.push(newNode)
          return newNode
        }; var newRoot = lf.tree.pushNodeBelowChild(node$jscomp$0, shouldPushDownFn, cloneFn)
  ...
  lf.proc.PushDownSelectionsPass.prototype.shouldSwapWithChild_ = function (queryContext, node) {
    ...
    var nodeIsJoin = node.predicate instanceof lf.pred.JoinPredicate; var childIsOuterJoin = queryContext.outerJoinPredicates.has(child.predicate.getId())
  ...
  lf.proc.SelectLogicalPlanGenerator.prototype.generateInternal = function () {
    this.generateNodes_()
    var rootNode = this.connectNodes_(); var planRewriter = new lf.proc.LogicalPlanRewriter(rootNode, this.query, this.rewritePasses_)
    return planRewriter.generate()
  }
  ...
  lf.proc.SelectLogicalPlanGenerator.prototype.generateCrossProductNode_ = function () {
    this.query.from.length >= 2 && (this.crossProductNode_ = new lf.proc.CrossProductNode())
  }
  ...
  lf.proc.SelectLogicalPlanGenerator.prototype.generateSkipNode_ = function () {
    goog.isDefAndNotNull(this.query.skip) && this.query.skip > 0 && (this.skipNode_ = new lf.proc.SkipNode(this.query.skip))
  }
  ...
  lf.proc.SelectLogicalPlanGenerator.prototype.generateAggregationNode_ = function () {
    ...
    aggregatedColumns.length > 0 && (this.aggregationNode_ = new lf.proc.AggregationNode(aggregatedColumns))
  }
  ...
  lf.proc.GetRowCountStep.prototype.execInternal = function () {
    var rowIdIndex = this.indexStore_.get(this.table.getRowIdIndexName()); var relation = new lf.proc.Relation([], [this.table.getName()])
  ...
  lf.proc.GetRowCountPass.prototype.rewrite = function (rootNode, queryContext) {
    ...
    })[0]; var getRowCountStep = new lf.proc.GetRowCountStep(this.global_, tableAccessFullStep.table)
  ...
  lf.proc.GetRowCountPass.prototype.canOptimize_ = function (queryContext) {
    var isCandidate = queryContext.columns.length == 1 && queryContext.from.length == 1 && !goog.isDefAndNotNull(queryContext.where) && !goog.isDefAndNotNull(queryContext.limit) && !goog.isDefAndNotNull(queryContext.skip) && !goog.isDefAndNotNull(queryContext.groupBy)
    if (isCandidate) {
  ...
  lf.proc.GroupByStep.prototype.calculateGroupedRelations_ = function (relation) {
    var groupMap = new lf.structs.MapSet(); var getKey = function (entry) {
  ...
  lf.proc.IndexJoinPass.prototype.processJoinStep_ = function (joinStep) {
    if (joinStep.predicate.evaluatorType == lf.eval.Type.EQ && !joinStep.isOuterJoin) {
      ...
      }; var leftCandidate = getCandidate(joinStep.getChildAt(0)); var rightCandidate = getCandidate(joinStep.getChildAt(1))
  ...
  $jscomp.scope.calculateCartesianProduct = function (keyRangeSets) {
    ...
    }); var it = goog.iter.product.apply(null, keyRangeSetsAsArrays); var combinations = []
  ...
  lf.proc.NotBoundKeyRangeCalculator.prototype.getKeyRangeCombinations = function () {
    return this.indexSchema_.columns.length == 1 ? [lf.index.SingleKeyRange.all()] : [this.indexSchema_.columns.map(function () {
  ...
  lf.proc.BoundKeyRangeCalculator.prototype.calculateKeyRangeMap_ = function (queryContext) {
    ...
    this.predicateMap_.keys().forEach(function (columnName) {
      var predicateIds = this.predicateMap_.get(columnName); var predicates = predicateIds.map(function (predicateId) {
        return queryContext.getPredicate(predicateId)
      }, this); var keyRangeSetSoFar = new lf.index.SingleKeyRangeSet([lf.index.SingleKeyRange.all()])
      predicates.forEach(function (predicate) {
  ...
  lf.proc.BoundKeyRangeCalculator.prototype.fillMissingKeyRanges_ = function (keyRangeMap) {
    for (var i = this.indexSchema_.columns.length - 1; i >= 0; i--) {
      var column = this.indexSchema_.columns[i]; var keyRangeSet = keyRangeMap.get(column.schema.getName()) || null
  ...
  lf.proc.BoundKeyRangeCalculator.prototype.getKeyRangeCombinations = function (queryContext) {
    ...
    this.combinations_ = this.indexSchema_.columns.length == 1 ? lf.structs.map.values(keyRangeMap)[0].getValues() : (0, $jscomp.scope.calculateCartesianProduct)(this.getSortedKeyRangeSets_(keyRangeMap))
    this.lastQueryContext_ = queryContext
    return this.combinations_
  }
  lf.proc.BoundKeyRangeCalculator.prototype.getSortedKeyRangeSets_ = function (keyRangeMap) {
    var sortHelper = lf.structs.map.create(); var priority = 0
  ...
  lf.proc.IndexRangeCandidate.prototype.isUsable = function () {
    ...
    for (var unboundColumnFound = !1, isUsable = !0, i = 0; i < this.indexSchema.columns.length; i++) {
      var column = this.indexSchema.columns[i]; var isBound = this.predicateMap_.has(column.schema.getName())
  ...
  lf.proc.IndexRangeCandidate.prototype.calculateCost = function (queryContext) {
    var combinations = this.getKeyRangeCalculator().getKeyRangeCombinations(queryContext); var indexData = this.indexStore_.get(this.indexSchema.getNormalizedName())
  ...
  lf.proc.IndexRangeScanStep.prototype.toContextString = function (context) {
    var string = this.toString(); var keyRanges = this.keyRangeCalculator.getKeyRangeCombinations(context); var string = string.replace('?', keyRanges.toString())
  ...
  lf.proc.IndexRangeScanStep.prototype.execInternal = function (relations, opt_journal, opt_context) {
    var context = opt_context; var keyRanges = this.keyRangeCalculator.getKeyRangeCombinations(context); var index = this.indexStore_.get(this.index.getNormalizedName()); var rowIds
    rowIds = keyRanges.length == 1 && keyRanges[0] instanceof lf.index.SingleKeyRange && keyRanges[0].isOnly() ? lf.index.slice(index.get(keyRanges[0].from), !1, this.useLimit ? context.limit : void 0, this.useSkip ? context.skip : void 0) : index.getRange(keyRanges, this.reverseOrder, this.useLimit ? context.limit : void 0, this.useSkip ? context.skip : void 0)
  ...
  lf.proc.SelectStep.prototype.execInternal = function (relations, opt_journal, opt_context) {
    var context = opt_context; var predicate = context.getPredicate(this.predicateId)
  ...
  lf.proc.IndexRangeScanPass.prototype.rewrite = function (rootNode, queryContext) {
    ...
    tableAccessFullSteps.forEach(function (tableAccessFullStep) {
      ...
      if (selectStepsCandidates.length != 0) {
        var costEstimator = new lf.proc.IndexCostEstimator(this.global_, tableAccessFullStep.table); var indexRangeCandidate = costEstimator.chooseIndexFor(queryContext, selectStepsCandidates.map(function (c) {
  ...
  lf.proc.IndexRangeScanPass.prototype.replaceWithIndexRangeScanStep_ = function (indexRangeCandidate, predicateToSelectStepMap, tableAccessFullStep) {
    var predicateIds = indexRangeCandidate.getPredicateIds(); var selectSteps = predicateIds.map(function (predicateId) {
      return predicateToSelectStepMap.get(predicateId)
    })
    selectSteps.forEach(lf.tree.removeNode)
    var indexRangeScanStep = new lf.proc.IndexRangeScanStep(this.global_, indexRangeCandidate.indexSchema, indexRangeCandidate.getKeyRangeCalculator(), !1); var tableAccessByRowIdStep = new lf.proc.TableAccessByRowIdStep(this.global_, tableAccessFullStep.table)
  ...
  lf.proc.InsertStep.assignAutoIncrementPks_ = function (table, values, indexStore) {
    var pkIndexSchema = table.constraint_.primaryKey_; var autoIncrement = goog.isNull(pkIndexSchema) ? !1 : pkIndexSchema.columns[0].autoIncrement
    if (autoIncrement) {
      var pkColumnName = pkIndexSchema.columns[0].schema.getName(); var index = indexStore.get(pkIndexSchema.getNormalizedName()); var max = index.stats().maxKeyEncountered; var maxKey = goog.isNull(max) ? 0 : max
      values.forEach(function (row) {
        row.payload_[pkColumnName] != 0 && goog.isDefAndNotNull(row.payload_[pkColumnName]) || (maxKey++, row.payload_[pkColumnName] = maxKey)
      })
    }
  }
  ...
  lf.proc.OrderByStep.prototype.execInternal = function (relations) {
    if (relations.length == 1) {
      var distinctColumn = this.findDistinctColumn_(relations[0]); var relationToSort = goog.isNull(distinctColumn) ? relations[0] : relations[0].getAggregationResult(distinctColumn)
  ...
  lf.proc.OrderByStep.prototype.comparator_ = function (getLeftPayload, getRightPayload) {
    var order; var leftPayload; var rightPayload; var comparisonIndex = -1
    do {
      comparisonIndex++
  ...
  lf.proc.RelationTransformer.prototype.handleAggregatedColumns_ = function () {
    if (this.columns_.length == 1 && this.columns_[0].aggregatorType == lf.fn.Type.DISTINCT) {
      var distinctRelation = this.relation_.getAggregationResult(this.columns_[0]); var newEntries = distinctRelation.entries.map(function (entry) {
  ...
  lf.proc.RelationTransformer.prototype.handleNonAggregatedColumns_ = function () {
    var transformedEntries = Array(this.relation_.entries.length); var isPrefixApplied = this.relation_.isPrefixApplied()
  ...
  lf.proc.RelationTransformer.transformMany = function (relations, columns) {
    var entries = relations.map(function (relation) {
      var relationTransformer = new lf.proc.RelationTransformer(relation, columns); var singleEntryRelation = relationTransformer.getTransformed()
  ...
  lf.proc.ProjectStep.prototype.execInternal = function (relations) {
    return relations.length == 0 ? [lf.proc.Relation.createEmpty()] : relations.length == 1 ? [this.execNonGroupByProjection_(relations[0])] : [this.execGroupByProjection_(relations)]
  }
  ...
  lf.proc.MultiColumnOrPass.prototype.rewrite = function (rootNode, queryContext) {
    ...
    var indexRangeCandidates; var orSelectStep; var i = 0
    do {
  ...
  lf.proc.MultiColumnOrPass.prototype.findIndexRangeCandidates_ = function (selectStep, queryContext) {
    var predicate = queryContext.getPredicate(selectStep.predicateId); var tables = predicate.getTables()
    if (tables.size != 1) {
      return null
    }
    var tableSchema = lf.structs.set.values(tables)[0]; var indexCostEstimator = new lf.proc.IndexCostEstimator(this.global_, tableSchema); var indexRangeCandidates = null; var allIndexed = predicate.getChildren().every(function (childPredicate) {
  ...
  lf.proc.MultiColumnOrPass.prototype.replaceWithIndexRangeScan_ = function (selectStep, tableAccessFullStep, indexRangeCandidates) {
    var tableAccessByRowIdStep = new lf.proc.TableAccessByRowIdStep(this.global_, tableAccessFullStep.table); var multiIndexRangeScanStep = new lf.proc.MultiIndexRangeScanStep()
  ...
  lf.proc.OrderByIndexPass.prototype.applyTableAccessFullOptimization_ = function (orderByStep) {
    var rootNode = orderByStep; var tableAccessFullStep = lf.proc.OrderByIndexPass.findTableAccessFullStep_(orderByStep.getChildAt(0))
    if (!goog.isNull(tableAccessFullStep)) {
      ...
      var indexRangeScanStep = new lf.proc.IndexRangeScanStep(this.global_, indexRangeCandidate.indexSchema, new lf.proc.NotBoundKeyRangeCalculator(indexRangeCandidate.indexSchema), indexRangeCandidate.isReverse); var tableAccessByRowIdStep = new lf.proc.TableAccessByRowIdStep(this.global_, tableAccessFullStep.table)
      tableAccessByRowIdStep.addChild(indexRangeScanStep)
  ...
  lf.proc.OrderByIndexPass.prototype.applyIndexRangeScanStepOptimization_ = function (orderByStep) {
    var rootNode = orderByStep; var indexRangeScanStep = lf.proc.OrderByIndexPass.findIndexRangeScanStep_(orderByStep.getChildAt(0))
    if (!goog.isNull(indexRangeScanStep)) {
  ...
  lf.proc.OrderByIndexPass.checkOrder_ = function (orderBy, indexSchema) {
    ...
    }, 0); var ordersRightBitmask = indexSchema.columns.reduce(function (soFar, indexedColumn) {
      return soFar << 1 | (indexedColumn.order == lf.Order.DESC ? 0 : 1)
    }, 0); var xorBitmask = ordersLeftBitmask ^ ordersRightBitmask; var isNatural = xorBitmask == 0; var isReverse = xorBitmask == Math.pow(2, Math.max(orderBy.length, indexSchema.columns.length)) - 1
  ...
  lf.proc.PhysicalPlanFactory.prototype.createPlan_ = function (logicalPlan, queryContext, opt_rewritePasses) {
    ...
    if (goog.isDefAndNotNull(opt_rewritePasses)) {
      var planRewriter = new lf.proc.PhysicalPlanRewriter(rootStep, queryContext, opt_rewritePasses); var rootStep = planRewriter.generate()
    }
  ...
  lf.proc.LockTableEntry_.prototype.canAcquireLock = function (taskId, lockType) {
    var noReservedReadOnlyLocksExist = goog.isNull(this.reservedReadOnlyLocks) || this.reservedReadOnlyLocks.size == 0
    if (lockType == lf.proc.LockType.EXCLUSIVE) {
      var noSharedLocksExist = goog.isNull(this.sharedLocks) || this.sharedLocks.size == 0
  ...
  lf.proc.Runner.prototype.consumePending_ = function () {
    for (var queue = this.queue_.getValues(), i = 0; i < queue.length; i++) {
      var task = queue[i]; var acquiredLock
  ...
  lf.proc.Runner.prototype.requestTwoPhaseLock_ = function (task, lockType1, lockType2) {
    var acquiredLock = !1; var acquiredFirstLock = this.lockManager_.requestLock(task.getId(), task.getScope(), lockType1)
  ...
  lf.debug.getGlobal_ = function (dbName) {
    var global = lf.Global.get(); var ns = new lf.service.ServiceId('ns_' + dbName)
    return global.isRegistered(ns) ? global.getService(ns) : null
  }
  lf.debug.listDb_ = function () {
    var global = lf.Global.get(); var dbList = {}
  ...
  lf.debug.listTables_ = function (dbName) {
    var global = lf.debug.getGlobal_(dbName); var tables = {}
  ...
  lf.debug.inspectTable_ = function (dbName, tableName, opt_limit, opt_skip) {
    var global = lf.debug.getGlobal_(dbName); var contents = []
    if (goog.isDefAndNotNull(global)) {
      var table = null
      try {
      ...
      if (goog.isDefAndNotNull(table)) {
        var indexStore = global.getService(lf.service.INDEX_STORE); var cache = global.getService(lf.service.CACHE); var rowIds = indexStore.get(table.getRowIdIndexName()).getRange(void 0, !1, opt_limit, opt_skip)
  ...
  lf.DiffCalculator.prototype.applyDiff = function (oldResults, newResults) {
    for (var oldEntries = goog.isNull(oldResults) ? [] : oldResults.entries, longestCommonSubsequenceLeft = goog.math.longestCommonSubsequence(oldEntries, newResults.entries, this.comparator_.bind(this), function (indexLeft) {
      ...
      if (longestCommonSubsequenceLeft[commonIndex] == entry) {
        ...
        var removed = this.observableResults_.splice(commonIndex, 1); var changeRecord = lf.DiffCalculator.createChangeRecord_(i, removed, 0, this.observableResults_)
  ...
  lf.ObserverRegistry.prototype.addObserver = function (rawBuilder, callback) {
    var builder = rawBuilder; var queryId = this.getQueryId_(builder.query); var entry = this.entries_.get(queryId) || null
  ...
  lf.ObserverRegistry.prototype.removeObserver = function (builder, callback) {
    var query = builder.query; var queryId = this.getQueryId_(query); var entry = this.entries_.get(queryId) || null
  ...
  lf.ObserverRegistry.prototype.getTaskItemsForTables = function (tables) {
    ...
    this.entries_.forEach(function (entry) {
      var item = entry.getTaskItem(); var refersToTables = item.context.from.some(function (table) {
  ...
  lf.ObserverRegistry.prototype.updateResultsForQuery = function (query, results) {
    var queryId = this.getQueryId_(goog.isDefAndNotNull(query.clonedFrom) ? query.clonedFrom : query); var entry = this.entries_.get(queryId) || null
  ...
  lf.ObserverRegistry.Entry_.prototype.updateResults = function (newResults) {
    ...
    changeRecords.length > 0 && this.observers_.forEach(function (observerFn) {
      observerFn(changeRecords)
    })
  }
  lf.base = {}
  lf.base.init = function (global, opt_options) {
    var schema = global.getService(lf.service.SCHEMA); var options = opt_options || {}; var cache = new lf.cache.DefaultCache(schema)
    global.registerService(lf.service.CACHE, cache)
    var backStore = null; var observeExternalChanges = !1
  ...
  lf.proc.ExportTask.prototype.execSync = function () {
    var indexStore = this.global_.getService(lf.service.INDEX_STORE); var cache = this.global_.getService(lf.service.CACHE); var tables = {}
    this.schema_.tables().forEach(function (table) {
      var rowIds = indexStore.get(table.getRowIdIndexName()).getRange(); var payloads = cache.getMany(rowIds).map(function (row) {
        return row.payload_
      })
  ...
  lf.proc.ExportTask.prototype.exec = function () {
    var results = this.execSync(); var entry = new lf.proc.RelationEntry(new lf.Row(lf.Row.DUMMY_ID, results), !0)
  ...
  lf.proc.ImportTask.prototype.import_ = function () {
    var journal = new lf.cache.Journal(this.global_, this.scope_); var tx = this.backStore_.createTx(this.getType(), lf.structs.set.values(this.scope_), journal); var tableName
    for (tableName in this.data_.tables) {
      var tableSchema = this.schema_.table(tableName); var payloads = this.data_.tables[tableName]; var rows = payloads.map(function (value) {
        return tableSchema.createRow(value)
      }); var table = tx.getTable(tableName, tableSchema.deserializeRow, lf.backstore.TableType.DATA)
  ...
  lf.proc.Transaction = function (global) {
    ...
    lf.proc.StateTransitions_.size == 0 && this.initStateTransitions_()
  }
  ...
  lf.schema.BaseColumn.prototype.getIndices = function () {
    goog.isDefAndNotNull(this.indices_) || (this.indices_ = [], this.getTable().getIndices().forEach(function (index) {
      ...
      colNames.indexOf(this.name_) != -1 && this.indices_.push(index)
    }, this))
    return this.indices_
  }
  lf.schema.BaseColumn.prototype.getIndex = function () {
    if (!goog.isDef(this.index_)) {
      var indices = this.getIndices().filter(function (indexSchema) {
        return indexSchema.columns.length != 1 ? !1 : indexSchema.columns[0].schema.getName() == this.getName()
      }, this)
      this.index_ = indices.length > 0 ? indices[0] : null
    }
    return this.index_
  }
  ...
  lf.schema.Info.prototype.getReferencingForeignKeys = function (tableName, opt_constraintAction) {
    ...
    var cascadeConstraints = this.cascadeReferringFk_.get(tableName); var restrictConstraints = this.restrictReferringFk_.get(tableName)
  ...
  lf.schema.TableBuilder.prototype.checkPrimaryKeyNotForeignKey_ = function () {
    if (!goog.isNull(this.pkName_)) {
      ...
      }); var fkSpecIndex = 0; var conflict = this.fkSpecs_.some(function (fkSpec, i) {
        fkSpecIndex = i
  ...
  lf.schema.TableBuilder.prototype.checkPrimaryKeyDuplicateIndex_ = function () {
    if (!goog.isNull(this.pkName_)) {
      var extractName = function (indexedColumn) {
        return indexedColumn.name
      }; var pkColumnsJson = JSON.stringify(this.indices_.get(this.pkName_).map(extractName))
  ...
  lf.schema.TableBuilder.prototype.addPrimaryKey = function (columns, opt_autoInc) {
    ...
    cols.length == 1 && this.uniqueColumns_.add(cols[0].name)
  ...
  lf.schema.TableBuilder.prototype.addUnique = function (name, columns) {
    ...
    cols.length == 1 && (this.uniqueColumns_.add(cols[0].name), this.markFkIndexForColumnUnique_(cols[0].name))
  ...
  lf.schema.TableBuilder.prototype.normalizeColumns_ = function (columns, checkIndexable, opt_order, opt_autoInc) {
    var normalized = columns; var normalized = typeof columns[0] === 'string' ? columns.map(function (col) {
  ...
  lf.schema.TableBuilder.prototype.generateTableClass_ = function () {
    var that = this; var tableClass = function () {
      var columns = lf.structs.map.keys(that.columns_).map(function (colName) {
        ...
        return this[colName]
      }, this); var generateIndexedColumns = function (indexName) {
      ...
      var pk = goog.isNull(that.pkName_) ? null : new lf.schema.Index(that.name_, that.pkName_, !0, generateIndexedColumns.call(this, that.pkName_)); var notNullable = columns.filter(function (col) {
    ...
    tableClass.prototype.deserializeRow = function (dbRecord) {
      ...
      this.getColumns().forEach(function (col) {
        var key = col.getName(); var type = col.getType(); var value = dbRecord.value[key]
  ...
  lf.schema.TableBuilder.prototype.generateRowClass_ = function (columns$jscomp$0, indices) {
    ...
    rowClass.prototype.toDbPayload = function () {
      var obj = {}
      this.columns_.forEach(function (col) {
        var key = col.getName(); var type = col.getType(); var value = this.payload_[key]
    ...
    var getSingleKeyFn = function (column) {
      var colType = this.columns_.get(column.getName()); var keyOfIndexFn = this.evalRegistry_.getKeyOfIndexEvaluator(colType)
      return function (payload) {
        return keyOfIndexFn(payload[column.getName()])
      }
    }.bind(this); var getMultiKeyFn = function (columns) {
    ...
    indices.forEach(function (index$jscomp$0) {
      var key = index$jscomp$0.getNormalizedName(); var JSCompiler_inline_result; var index = index$jscomp$0
      JSCompiler_inline_result = index.columns.length == 1 ? getSingleKeyFn(index.columns[0].schema) : getMultiKeyFn(index.columns)
      functionMap[key] = JSCompiler_inline_result
    })
    rowClass.prototype.keyOfIndex = function (indexName) {
      return indexName.indexOf('#') != -1 ? this.id() : functionMap.hasOwnProperty(indexName) ? functionMap[indexName](this.payload_) : null
    }
    return rowClass
  }
  ...
  lf.schema.Builder.prototype.checkForeignKeyValidity_ = function (builder) {
    ...
    fkSpecArray.forEach(function (specs) {
      ...
      var table = this.tableBuilders_.get(parentTableName); var parentSchema = table.getSchema(); var parentColName = specs.parentColumn
      if (!parentSchema.hasOwnProperty(parentColName)) {
        throw new lf.Exception(537, specs.name)
      }
      var localSchema = builder.getSchema(); var localColName = specs.childColumn
  ...
  lf.schema.Builder.prototype.getGlobal = function () {
    var namespacedGlobalId = new lf.service.ServiceId('ns_' + this.schema_.name()); var global = lf.Global.get(); var namespacedGlobal
  ...
  try { if (module) { module.exports = lf } } catch (e) {}
}.bind(window))()
